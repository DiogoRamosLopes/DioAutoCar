...
<html lang="pt-BR">
<head>
  <title>Consulta de Clientes - Dio AutoCar</title>
  <meta charset="utf-8">
...
<div class="container mt-4">
  <h1 class="text-center py-3"><i class="fas fa-user-tie me-2"></i>Consulta de Clientes</h1>
  ...
  ?>
    <div class="client-card">
      ...
      <div class="client-info">
        ...
        <span>RG:</span> <?php echo $linha['rg']; ?>
      </div>
      <div class="client-info">
        <i class="fas fa-phone"></i>
        <span>Celular:</span> <?php echo $linha['celular']; ?>
      </div>
      <div class="client-info">
      ...
      <div class="actions-container text-end">
        <button class="btn btn-action btn-edit" onclick="window.location.href='alterarCliente.php?cod=<?php echo $linha['codigo']; ?>'">
          <i class="fas fa-edit me-1"></i>Alterar
        </button>
        <button class="btn btn-sm btn-action btn-delete" 
          onclick="window.location.href='confirmarExcluir.php?cod=<?php echo $linha['codigo']; ?>&tabela=tb_cliente'">
