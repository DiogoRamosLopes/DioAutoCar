...
<head>
  ...
  <title>Cadastro de Fornecedor - Dio AutoCar</title>
...
<body>
  ...
  <div class="container">
    <h1 class="text-center py-3"><i class="fas fa-truck me-2"></i>Cadastro de Fornecedor</h1>
    
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <div class="form-container">
          <form action="recebeDadosFornecedor.php" method="POST">
            <div class="row">
              <div class="col-md-6">
                <label class="form-label"><i class="fas fa-building me-2"></i>Nome</label>
                <input class="form-control" name="nome" placeholder="Nome do fornecedor" required>
              </div>
              <div class="col-md-6">
                <label class="form-label"><i class="fas fa-id-card me-2"></i>CPF/CNPJ</label>
                <input class="form-control" name="cpf" placeholder="000.000.000-00 ou 00.000.000/0000-00" oninput="formatCPFCNPJ(this)" required>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <input type="email" class="form-control" name="email" placeholder="fornecedor@empresa.com" required>
              </div>
            </div>
  ...
  <script>
    ...
    function formatCPFCNPJ(input) {
      ...
      if (value.length <= 11) { // CPF
        ...
        if (value.length > 6) value = value.replace(/^(\d{2})\.(\d{3})(\d)/g, '$1.$2.$3');
        if (value.length > 10) value = value.replace(/^(\d{2})\.(\d{3})\.(\d{3})(\d)/g, '$1.$2.$3/$4');
        if (value.length > 15) value = value.replace(/^(\d{2})\.(\d{3})\.(\d{3})\/(\d{4})(\d)/g, '$1.$2.$3/$4-$5');
